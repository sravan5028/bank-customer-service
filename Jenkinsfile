  ...
  stages {
    ...
    stage('Push image') {
      steps {
        ...
        //withDockerRegistry(credentialsId: 'ecr:us-east-1:Devops_Guru', url: 'https://console.aws.amazon.com/ecr/repositories/cloud_guru/?region=us-east-1') {
        docker.withRegistry("https://console.aws.amazon.com/ecr/repositories/cloud_guru/?region=us-east-1", "ecr:us-east-1:Devops_Guru") {  
